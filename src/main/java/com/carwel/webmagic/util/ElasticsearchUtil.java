...
import com.carwel.webmagic.dto.EsPage;
...
//遍历 高亮结果集，覆盖 正常结果集
    ...
    public static Boolean createIndexMapping(String index,String type) {
        ...
        try {
            ...
            mapping = XContentFactory.jsonBuilder()
                    ...
                    .startObject("chapterNum")
                    .field("type","integer") //设置数据类型
                    .endObject()
                    .startObject("contentId")
                    .field("type","long")
                    .endObject()
                    .startObject("chapterName")
                    .field("type","keyword")
                    .endObject()
                    .startObject("chapterContext")
                    .field("type","keyword")
                    .endObject()
                    .startObject("contentName")
                    .field("type","keyword")
                    .endObject()
                    .startObject("categoryType")
                    .field("type","integer")
                    .endObject()
